...
File `sampleList.json` contains a sample list to start with.
Once the sampleCommons is launched, run the following:
```bash
curl --location 'http://localhost:3000/api/v1/data-library/lists' \
      ...
      "items": {
        "DS_111": {
          ...
          "items": {
            ...
            "FIHR": {
              "type": "AdditionalData",
              "description": "(Fast Healthcare Interoperability Resources 1 ) standard defines how healthcare information can be exchanged between different computer systems",
        ...
        "DS_723": {
          ...
          "items": {
            "drs://dg.4503:31948a1c-0be4-43d5-aab0-2a4471c2ef28": {
              ...
              "size": "42 GB",
              "description": "Randomly generated csv file containing biomedical or genomic information."
            },
            "drs://dg.4503:b0815063-ac00-4958-a17f-f3e4df020ed8": {
              ...
              "size": "11 GB",
              "description": "Randomly generated bam file containing biomedical or genomic information."
            },
            "drs://dg.4503:6e78fe3b-cce1-49de-916b-eccf9e9cec93": {
              ...
              "size": "88 GB",
              "description": "Randomly generated tsv file containing biomedical or genomic information."
            },
            "drs://dg.4503:726ae41f-3b44-4a7b-adab-9f0c790a399f": {
              ...
              "size": "25 KB",
              "description": "Randomly generated pfb file containing biomedical or genomic information."
            },
            "drs://dg.4503:ce1f5a36-b987-4b67-82c3-27cc1b49f4b7": {
              ...
              "size": "27 KB",
              "description": "Randomly generated tar file containing biomedical or genomic information."
            },
            "Genome_Stats": {
              "name" : "Genome_Stats",
              ...
              "type": "AdditionalData",
              "dataset_guid": "phs000003.v1.p1.c1"
            }
          }
        }
      }
