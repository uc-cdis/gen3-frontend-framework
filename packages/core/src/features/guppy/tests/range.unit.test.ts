...
describe('build range queries', () => {
  it('should build a query with all parameters', () => {
    ...
    expect(cleanString(results.query)).toContain(
      cleanString(
        `queryrangeQuery($accessibility:Accessibility,$range_0:JSON,$range_1:JSON,$range_2:JSON,$range_3:JSON,$range_4:JSON){CaseCentric__aggregation{range_0:case(accessibility:$accessibilityfilter:$range_0){files{data_type{histogram{count}}}}range_1:case(accessibility:$accessibilityfilter:$range_1){files{data_type{histogram{count}}}}range_2:case(accessibility:$accessibilityfilter:$range_2){files{data_type{histogram{count}}}}range_3:case(accessibility:$accessibilityfilter:$range_3){files{data_type{histogram{count}}}}range_4:case(accessibility:$accessibilityfilter:$range_4){files{data_type{histogram{count}}}}}}`,
      ),
    );
