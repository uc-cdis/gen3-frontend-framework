...
export const GEN3_DOWNLOADS_ENDPOINT = process.env.GEN3_DOWNLOADS_ENDPOINT || 'downloads';
export const GEN3_AUTH_API = process.env.NEXT_PUBLIC_GEN3_AUTH_API || `${GEN3_API}/user`;
