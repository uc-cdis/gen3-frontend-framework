...
import type { ReactEChartsProps } from '../../components/charts/echarts/ReactECharts';
import ReactECharts from '../../components/charts/echarts/ReactECharts';
...
const GraphView = ({ categories, dictionary, selectedId }: GraphViewType) => {
        ...
        feature: {
          ...
          myZoomIn: {
            ...
            onclick: (params: GraphReactEChartsProps) => {
              ...
              const zoom = series?.[0] ? series[0].zoom : 1;
      ...
      <ReactECharts
        ...
        events={{
          graphroam: function () {
            ...
            const thisOptions: GraphReactEChartsProps['option'] =
              thisApi.getOption();
