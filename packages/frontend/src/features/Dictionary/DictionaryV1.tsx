...
import GraphView from './GraphViewV1';
import TableSearch from './TableSearch';
import type { MatchingSearchResult, ViewType } from './types';
  ...
  return (
    <div className="grid h-full min-h-0 w-full min-w-0 grid-cols-[320px_minmax(0,1fr)]">
      <aside className="overflow-auto border-r border-base-light bg-white">
        <div className="sticky top-0 z-20 border-b border-base-light bg-base-lightest p-6 backdrop-blur">
          {config?.showGraph ? (
