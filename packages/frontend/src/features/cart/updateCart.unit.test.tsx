...
describe('updateCart, addToCart', () => {
  it('add single file', () => {
    ...
    addToCart([{ file_name: 'filey', id: '1' } as CartItem], [], dispatchMock);
  ...
  it('add single file already in cart', () => {
    ...
    addToCart(
      [{ file_name: 'filey', id: '1' } as CartItem],
      [{ id: '1' } as CartItem],
      dispatchMock,
    );
  ...
  it('add multiple files, some already in cart', () => {
    ...
    addToCart(
      [
        { file_name: 'filey', id: '1' },
        { file_name: 'abc', id: '2' },
        { file_name: 'filey', id: '3' },
        { file_name: 'abc', id: '4' },
      ] as CartItem[],
      [{ id: '2' }, { id: '4' }] as CartItem[],
      dispatchMock,
    );
  ...
  it('add too many files', () => {
    const dispatchMock = jest.fn();
    const files = Array(9999).fill({ file_name: 'filey', id: '1' });
    addToCart(files, [{ id: '2' }, { id: '4' }] as CartItem[], dispatchMock);
...
describe('updateCart, removeFromCart', () => {
  it('remove single file', () => {
    removeFromCart(
      [{ file_name: 'abc', id: '2' }] as CartItem[],
      [{ id: '2' } as CartItem],
      jest.fn(),
    );
