...
interface GuppyDropdownMenuItemProps extends Pick<GuppyActionButtonProps, "disabled" | "Modal400" | "Modal403" | "done" | "customErrorMessage" | "hideNotification"|"actionFunction"|"actionArgs"> {
  title: string;
  idx: number;
};
...
export const GuppyDropdownWithIcon = ({
  disableTargetWidth,
  LeftIcon,
  RightIcon = (
  ...
  return (
    ...
    >
      ...
      >
        ...
        {dropdownElements.map(({ title,icon, disabled , actionFunction, actionArgs}, idx) => (
