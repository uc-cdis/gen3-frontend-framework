 ...
 */
export interface FormContentProps extends Omit<TextContentProps, 'type' | 'text'> {
...
const FormContent = ({
  ...
  switch (type) {
    ...
    default:
      ...
      if (text) {
        return <TextContent text={text} className={className} type={type as ContentType} key= {keyString}/>
      }
  }
};
