...
const SearchInput: React.FC<{
  ...
  return (
    <TooltipContainer
      ...
      baseZIndex={baseZIndex as number}
...
function TableHeader<TData>({
  ...
  const inputRef = useRef(null as any); // updated apr 10 25 to get build to work
  const timeoutRef = useRef(null as any); // updated apr 10 25 to get build to work
