...
const ProjectCard = ({title, description, icon}: HomepageCardProps) =>
(
    ...
    <div className="pb-5">
    <Button className="py-3 w-full h-1/6 !bg-cbds-secondary hover:!bg-cbds-monosecondary text-white text-lg">Explore</Button>
    </div>
    </Card>
);
