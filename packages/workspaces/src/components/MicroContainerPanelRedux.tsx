...
// } from '@gen3/core';
// import { useWorkspaceStatusContext } from '../providers/WorkspaceStatusProvider';
//
...
//   // const { lastError, launch, terminate, resetStatus } =
...
//     selectRequestedWorkspaceStatusTimestamp,
//   );
//   const { startWorkspace } = useWorkspaceStatusContext();
//
...
//   useEffect(() => {
//     if (status !== WorkspaceStatus.LaunchingError) return;
