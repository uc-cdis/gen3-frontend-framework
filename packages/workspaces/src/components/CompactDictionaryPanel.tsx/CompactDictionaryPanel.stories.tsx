...
const nodes: SchemaNode[] = [
  {
    ...
    title: 'Audit Event',
    description:
      'Harmonized identity and compliance audit records from API audit trails such as CloudTrail, GCP Audit Log, Azure Activity Log, and S3 access logs.',
    ...
    properties: {
      ...
      userId: {
        type: 'string',
        description:
          'The identity of the user or system account that performed the action.',
      },
      srcIp: {
        type: 'string',
      ...
      actionName: {
        type: 'string',
        description:
          'The API call or operation performed (e.g. PutObject, AssumeRole, CreateInstance).',
      },
      resource: {
        type: 'string',
      ...
      result: {
        ...
        enum: ['success', 'failure', 'denied', 'error', 'unknown'],
      },
      isReadOnly: {
        type: 'boolean',
      ...
      eventType: {
        ...
        enum: ['api_call', 'console_signin', 'service_event', 'other'],
      },
      requestParameters: {
        type: 'string',
      ...
      cloudAccountId: {
        type: 'string',
        description:
          'The cloud account or subscription where this event was observed.',
      },
      eventSource: {
        type: 'string',
  ...
  },
  {
    ...
    title: 'Program',
    description:
      'A top-level organizational unit for the SOC, representing a security mission, business unit, or operational scope.',
  ...
  },
  {
    ...
    title: 'Project',
    description:
      'A monitored environment, cloud account, subscription, or on-prem enclave within the SOC.',
    category: 'administrative',
    properties: {
      code: {
        type: 'string',
      ...
      cloudAccountId: {
        type: 'string',
        description:
          'The cloud account or subscription identifier (AWS account ID, GCP project ID, Azure subscription ID, or on-prem site ID).',
      },
      cloudProvider: {
        type: 'string',
        description: 'The infrastructure provider for this project.',
        enum: ['aws', 'gcp', 'azure', 'on_prem', 'hybrid'],
      },
    },
    required: [],
    links: [
  ...
  },
  {
    ...
    description:
      'Harmonized threat detection events from security services such as WAF, GuardDuty, GCP SCC, and Azure Sentinel.',
    category: 'data_observations',
    properties: {
      timestamp: {
        type: 'string',
      ...
      action: {
        ...
        enum: ['allow', 'block', 'CAPTCHA', 'challenge', 'count', 'other'],
      },
      severity: {
        type: 'string',
      ...
      findingType: {
        type: 'string',
        description:
          'The detection or finding type as reported by the source (e.g. Recon:EC2/PortProbeUnprotectedPort).',
      },
      srcIp: {
        type: 'string',
      ...
      ruleId: {
        type: 'string',
        description:
          'The identifier of the rule or detection that triggered this event.',
      },
      cloudAccountId: {
        type: 'string',
        description:
