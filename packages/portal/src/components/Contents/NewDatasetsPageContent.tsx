...
export interface NewDatasetsPageConfig {
...
const NewDatasetsPageContent = ({title, introduction, sections}: NewDatasetsPageConfig) => {
  return (
    <React.Fragment>
...
export default NewDatasetsPageContent;
