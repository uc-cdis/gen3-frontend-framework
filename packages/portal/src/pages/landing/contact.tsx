      ...
      <div className="flex flex-row justify-center">
        <div className="flex flex-col justify-evenly pb-10 text-xl max-w-10">
          ...
          <Text className="prose text-black text-2xl p-8">
            For technical questions about the HEAL Platform, contact our
          ...
          <Text className="prose text-black text-2xl p-8">
            For data-related questions, contact the data stewards from RENCI/RTI
            via
            <a
              className="text-gen3-base_blue flex flex-row items-baseline no-underline font-bold"
              href="http://bit.ly/HEALStewardsConnect"
            >
              <FaExternalLinkAlt className="pr-1 pt-2" /> the HEAL Stewards
              contact form
            </a>
          </Text>
          <Text className="prose text-black text-2xl p-8">
            For general inquiries and questions about funding, contact the NIH
            HEAL Initiative&reg; office at
            <a
              className="text-gen3-base_blue flex flex-row items-baseline no-underline font-bold"
              href="mailto:HEALquestion@od.nih.gov"
            >
              <FaEnvelope className="pr-1 pt-2" />
              HEALquestion@od.nih.gov
            </a>
          </Text>
