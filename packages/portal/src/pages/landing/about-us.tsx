    ...
    <NavPageLayout {...{footerProps, headerProps}}>
      ...
      <div className='flex flex-row justify-center h-full'>
        <div className='flex flex-col justify-evenly pb-10 text-xl max-w-10'>
          ...
          <h1 className='font-bold text-4xl text-gen3-coal font-montserrat pb-4'>About Us</h1>
          <Text className='prose text-black text-2xl p-8'>
                        The HEAL Platform is powered by the <span className='font-bold'>Gen3</span> Data Commons Software Stack developed by the&nbsp;
            <a className='text-gen3-base_blue no-underline' href='https://ctds.uchicago.edu/' target='_blank' rel='noreferrer'>Center for Translational Data Science</a>
